...
def write_results(name_of_results):
    ...
    PandasTools.WriteSDF(df, name_of_results ,molColName='Mol_out' ,idName=None, allNumeric=False, properties=list(df.columns))
    ...
    PandasTools.WriteSDF(df_2, result_name_uniq ,molColName='Mol_out' ,idName=None, allNumeric=False, properties=list(df_2.columns))
